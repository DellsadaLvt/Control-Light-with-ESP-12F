...
// NTP SETUP
WiFiUDP u;
NTPClient n(u, "2.asia.pool.ntp.org", 7 * 3600); // khai bao truy cap NTP gio asia


/****/
int mins, hours;
int set_mins_on = 10, set_mins_off = 15;
short int state;
...
void State_led()
{
  ...
  ///*/////
  statusD4 = digitalRead(D4);
  EEPROM.write(96,statusD4);
  EEPROM.commit(); 
}
